...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5972689430').split()]
...
DOWNLOAD_TEXT_URL = "https://t.me/+dZMnFI10Okk5MGU1"

   # Custom Caption Under Button #
CAPTION_BUTTON = "Subscribe"
CAPTION_BUTTON_URL = "https://t.me/lovemovieshub"
